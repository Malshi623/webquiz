...
//login
    ...
    //balloonshoot
    function balloonshoot_ict_level1(){
        $data = ['LoggedUserInfo'=>Admin::where('id','=',session('LoggedUser'))->first()];
        return view('admin.balloonshoot.balloonshoot_ict_levels.balloonshoot_ict_level1',$data);

    }
    //dartgame
    function dartgame_ict_level1(){
        $data = ['LoggedUserInfo'=>Admin::where('id','=',session('LoggedUser'))->first()];
        return view('admin.dartgame.dartgame_ict_levels.dartgame_ict_level1',$data);

    }
    //mountainclimb
    function mountainclimb_ict_level1(){
        $data = ['LoggedUserInfo'=>Admin::where('id','=',session('LoggedUser'))->first()];
        return view('admin.mountainclimb.mountainclimb_ict_levels.mountainclimb_ict_level1',$data);

    }
    //spinwheel
    function spinwheel_ict_level1(){
        $data = ['LoggedUserInfo'=>Admin::where('id','=',session('LoggedUser'))->first()];
        return view('admin.spinwheel.spinwheel_ict_levels.spinwheel_ict_level1',$data);
    ...
    //balloonshoot
    function balloonshoot_random_level1(){
        $data = ['LoggedUserInfo'=>Admin::where('id','=',session('LoggedUser'))->first()];
        return view('admin.balloonshoot.balloonshoot_random_levels.balloonshoot_random_level1',$data);

    }
    //dartgame
    function dartgame_random_level1(){
        $data = ['LoggedUserInfo'=>Admin::where('id','=',session('LoggedUser'))->first()];
        return view('admin.dartgame.dartgame_random_levels.dartgame_random_level1',$data);

    }
    //mountainclimb
    function mountainclimb_random_level1(){
        $data = ['LoggedUserInfo'=>Admin::where('id','=',session('LoggedUser'))->first()];
        return view('admin.mountainclimb.mountainclimb_random_levels.mountainclimb_random_level1',$data);

    }
    //spinwheel
    function spinwheel_random_level1(){
        $data = ['LoggedUserInfo'=>Admin::where('id','=',session('LoggedUser'))->first()];
        return view('admin.spinwheel.spinwheel_random_levels.spinwheel_random_level1',$data);
