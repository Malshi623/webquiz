...
<!--level buttons-->
<div>
<button class="button w3-brown w3-round-xxlarge w3-hover-khaki" onclick="document.location='{{route('user.balloonshoot_history_level1')}}'">01</button>&emsp;&emsp;&emsp;
