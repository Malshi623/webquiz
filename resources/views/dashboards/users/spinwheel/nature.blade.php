...
<!--level buttons-->
<div>
<button class="button w3-green w3-round-xxlarge w3-hover-light-green" onclick="document.location='{{route('user.spinwheel_biology_level1')}}'">01</button>&emsp;&emsp;&emsp;
